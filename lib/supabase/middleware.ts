 ...
 * Skips authentication if Supabase is not configured (using mock database)
 */
export async function updateSession(request: NextRequest) {
  ...
  // Allow all routes when using mock database
  ...
  // If this is not done, you might be causing the middleware to constantly
